...
public class UnicornListPrimary {
    ...
    public static void sellUnicorn(Unicorn unicorn) {
        for (Iterator it = unicornListPrimary.iterator(); it.hasNext(); ) {
            ...
            if (unicorn.getName().equals(unicorn.getName()) && unicorn.getBreed().equals(unicorn.getBreed()) && unicorn.getAvailability().equals(Availability.DOSTEPNY)) {
                ...
                if (unicorn.getName().equals(unicorn.getName()) && unicorn.getBreed().equals(unicorn.getBreed()) && unicorn.getAvailability().equals(Availability.NIEDOSTPENY)) {
                    System.out.println("Jednorozec " + unicorn.getName() + "został już sprzedany.");
                }
            } else if (unicorn.getName().equals(unicorn.getName()) && unicorn.getBreed().equals(unicorn.getBreed()) && unicorn.getAvailability().equals(Availability.NIEDOSTPENY)) {
                System.out.println("Jednorozec " + unicorn.getName() + "został już sprzedany.");
            }
        }
    }
